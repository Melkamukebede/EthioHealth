    ...
    res.json({
        ...
        data: {
            ...
            message: relevantInteractions.length === 0
                ...
                : ` ${relevantInteractions.length} interaction(s) found! ${hasHighRisk ? 'HIGH RISK - Consult your doctor immediately!' : 'Exercise caution.'}`,
